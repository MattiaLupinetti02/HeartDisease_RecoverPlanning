...
dominio_pulizia = STRIPS_domain(
    {'Lr_dusty':boolean, 'Gar_dusty':boolean, 'Lr_dirty_floor':boolean, 'Dustcloth_clean':boolean, 'Rob_loc':{'lr','garage'}},
    {Strips('sw_lr',{'Rob_loc':'lr', 'Lr_dirty_floor':True},{'Lr_dirty_floor':False, 'Lr_dusty':True}),
     Strips('mt_lr',{'Rob_loc':'garage'},{'Rob_loc':'lr'}),
     Strips('d_g',{'Rob_loc':'garage','Gar_dusty':True, 'Duchcloth_clear':True},{'Gar_dusty':False,'Duchcloth_clear':False}),
     Strips('d_lr',{'Rob_loc':'lr', 'Duchcloth_clear':True,'Lr_dusty':True},{'Lr_dusty':False}),
     Strips('mt_g',{'Rob_loc':'lr'},{'Rob_loc':'garage'}),
     Strips('sw_g',{'Rob_loc':'garage', 'Gar_dirty_floor':True},{'Gar_dirty_floor':False, 'Gar_dusty':True})
    })

problema_pulizia = Planning_problem(dominio_pulizia,
                                    {'Rob_loc':'garage', 'Lr_dusty':True,'Gar_dusty':True,
                                     'Lr_dirty_floor':False, 'Gar_dirty_floor':False, 'Duchcloth_clear':True},
                                    {'Lr_dusty':False,'Gar_dusty':False}
