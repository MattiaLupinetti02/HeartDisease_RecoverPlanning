...
from stripsProblem import problem0, problem1, problem2, blocks1, blocks2, blocks3,problema_pulizia

ricerca = SearcherMPP(Forward_STRIPS(problema_pulizia)) #A* with MPP
